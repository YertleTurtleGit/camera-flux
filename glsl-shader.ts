...
class GLSL_OPERATORS {
   ...
   public static readonly ABSOLUTE: GLSL_OPERATOR = {
      NAME: METHOD.ABSOLUTE,
      TYPE: METHOD,
   };
...
class GlslRendering {
   ...
   public getJsImage(onloadCallback): HTMLImageElement {
...
abstract class GlslVector extends GlslVariable {
   public abstract absolute(): GlslVector;
...
class GlslFloat extends GlslVariable {
   ...
   public absolute(): GlslFloat {
      return this.getGlslFloatResult([this], GLSL_OPERATORS.ABSOLUTE);
   }
...
class GlslVector3 extends GlslVector {
   ...
   public absolute(): GlslVector3 {
      return this.getGlslVector3Result([this], GLSL_OPERATORS.ABSOLUTE);
   }
...
class GlslVector4 extends GlslVector {
   ...
   public absolute(): GlslVector4 {
      return this.getGlslVector4Result([this], GLSL_OPERATORS.ABSOLUTE);
   }
   public length(): GlslFloat {
      return this.getGlslFloatResult([this], GLSL_OPERATORS.LENGTH);
   }
